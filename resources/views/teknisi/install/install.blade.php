        ...
        <div class="w-full mb-12 px-4 mt-4">
            <div class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded bg-white">
                ...
                <div class="block w-full pb-5">
                    <!-- Projects table -->
                    <form action="/teknisi/installation/{{ $installation->id }}"
                        class="form-installation init-validatation" method="POST" novalidate>
                        <input type="text" hidden readonly name="_token" value="{{ csrf_token() }}">
                        <input type="text" hidden readonly name="_method" value="put">
                        <div class="grid lg:grid-cols-2 lg:gap-4 mb-4">
                            <div class="px-4">
                                <div class="form-control w-full">
                                    ...
                                    <input type="text" placeholder="username" name="username" class="form-input my-input"
                                        required>
                                    <label id="username-error" class="error text-xs text-red-500 hidden"
                                        for="username"></label>
                                </div>
                                <div class="form-control w-full">
                                    <label class="label">
                                    ...
                                    <label id="location-error" class="error text-xs text-red-500 hidden"
                                        for="location"></label>
                                </div>
                                <div class="form-control w-full">
                                    <label class="label">
                                ...
                                <div class="form-control w-full">
                                    ...
                                    <input type="text" value="Rp.@rupiah($installation->package->price)"
                                        class="form-input my-input bg-gray-300" disabled>
                                </div>
                            </div>
                            <div class="px-4">
                                <div class="form-control w-full">
                                    ...
                                    <input type="text" name="redaman" placeholder="" class="form-input my-input" required>
                                    <label id="redaman-error" class="error text-xs text-red-500 hidden"
                                        for="redaman"></label>
                                </div>
                                <div class="flex lg:flex-row flex-col justify-between w-full">
                                    <div class="form-control lg:w-1/3 w-full">
                                        ...
                                        <input type="text" name="spliter" placeholder="" class="form-input my-input"
                                            required>
                                        <label id="spliter-error" class="error text-xs text-red-500 hidden"
                                            for="spliter"></label>
                                    </div>
                                    <div class="form-control lg:w-1/5 w-full">
                                        ...
                                        <input type="text" data-rule-number="true" name="port" placeholder=""
                                            class="form-input my-input" required>
                                    ...
                                    <div class="form-control lg:w-1/3 w-full">
                                        ...
                                        <input type="text" data-rule-number="true" name="number_modem" placeholder=""
                                            class="form-input my-input"
                                            required>
                                        <label id="number_modem-error" class="error text-xs text-red-500 hidden"
                                            for="number_modem"></label>
                                    </div>
                                </div>
                                <div class="form-control w-full">
                                    <label class="label">
                                    ...
                                    <input data-rule-number="true" type="text" name="installation_costs"
                                        value="Rp.@rupiah($installation->installation_costs)"
                                        class="form-input my-input bg-gray-300" disabled>
                                ...
                                <div class="form-control w-full">
                                    ...
                                    <input data-rule-number="true" type="text" name="discount"
                                        value="Rp.@rupiah($installation->discount)" disabled
                                        class="form-input my-input bg-gray-300">
                                </div>
                ...
                <div class="form-control w-full">
                    ...
                    <select name="inventory-name" class="form-select" required>
                        ...
                        @foreach ($inventories as $inv)
                            <option value="{{ $inv->id . ' | ' . $inv->stock . ' | ' . $inv->name }}">{{ $inv->name }}
                            </option>
                        @endforeach
                    </select>
